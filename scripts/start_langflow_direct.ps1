# Script direto para iniciar Langflow no ambiente virtual
# Execute este script diretamente no PowerShell
...
# Ativar ambiente virtual (usando o comando que você usa)
